...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon = QIcon()
        icon.addFile(os.path.join(self.uidir, u"icons/icon-app.jpg"), QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon1 = QIcon()
        icon1.addFile(os.path.join(self.uidir, u"icons/icon-import.png"), QSize(), QIcon.Normal, QIcon.On)
        ...
        icon2 = QIcon()
        icon2.addFile(os.path.join(self.uidir, u"icons/icon-saveas.png"), QSize(), QIcon.Normal, QIcon.On)
        ...
        icon3 = QIcon()
        icon3.addFile(os.path.join(self.uidir, u"icons/icon-preview.png"), QSize(), QIcon.Normal, QIcon.On)
        ...
        icon4 = QIcon()
        icon4.addFile(os.path.join(self.uidir, u"icons/icon-update.png"), QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon5 = QIcon()
        icon5.addFile(os.path.join(self.uidir, u"icons/icon-license.png"), QSize(), QIcon.Normal, QIcon.Off)
        self.actionLicense.setIcon(icon5)
        self.actionLicense.setFont(font1)
        self.actionAbout = QAction(MainWindow)
        self.actionAbout.setObjectName(u"actionAbout")
        icon6 = QIcon()
        icon6.addFile(os.path.join(self.uidir, u"icons/icon-about.jpg"), QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon7 = QIcon()
        icon7.addFile(os.path.join(self.uidir, u"icons/icon-config-timer.png"), QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon8 = QIcon()
        icon8.addFile(os.path.join(self.uidir, u"icons/icon-email-notification.png"), QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon9 = QIcon()
        icon9.addFile(os.path.join(self.uidir, u"icons/icon-formula.png"), QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon10 = QIcon()
        icon10.addFile(os.path.join(self.uidir, u"icons/icon-webdriver.png"), QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon11 = QIcon()
        icon11.addFile(os.path.join(self.uidir, u"icons/icon-resource.png"), QSize(), QIcon.Normal, QIcon.Off)
...
#if QT_CONFIG(tooltip)
        self.actionUpdate.setToolTip(QCoreApplication.translate("MainWindow", u"Update Tool version", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(statustip)
        self.actionUpdate.setStatusTip(QCoreApplication.translate("MainWindow", u"Update Tool version", None))
#endif // QT_CONFIG(statustip)
        self.actionLicense.setText(QCoreApplication.translate("MainWindow", u"License", None))
#if QT_CONFIG(tooltip)
        self.actionLicense.setToolTip(QCoreApplication.translate("MainWindow", u"License check", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(statustip)
        self.actionLicense.setStatusTip(QCoreApplication.translate("MainWindow", u"License check", None))
#endif // QT_CONFIG(statustip)
...
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(statustip)
        self.actionRepeat_Timer.setStatusTip(QCoreApplication.translate("MainWindow", u"Config timer for repeat operation", None))
#endif // QT_CONFIG(statustip)
#if QT_CONFIG(shortcut)
...
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(statustip)
        self.actionEmail_Notification.setStatusTip(QCoreApplication.translate("MainWindow", u"Setup email list and notification condition", None))
#endif // QT_CONFIG(statustip)
#if QT_CONFIG(shortcut)
...
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(statustip)
        self.actionProfit_Formula.setStatusTip(QCoreApplication.translate("MainWindow", u"Set Profit Formula for Output File", None))
#endif // QT_CONFIG(statustip)
#if QT_CONFIG(shortcut)
...
#if QT_CONFIG(statustip)
        self.actionWeb_Browser_Driver.setStatusTip(QCoreApplication.translate("MainWindow", u"Select Web Driver", None))
#endif // QT_CONFIG(statustip)
#if QT_CONFIG(shortcut)
...
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(statustip)
        self.actionResource.setStatusTip(QCoreApplication.translate("MainWindow", u"Config Tool Resource (i.e. number of thread/core used by tool)", None))
#endif // QT_CONFIG(statustip)
#if QT_CONFIG(shortcut)
